...
This section shows the parameters of `add-c` and the important things to note about them:

[options='header']
[cols="15%,85%"]
|====================
| Parameter | Important point to note
| `n/NAME` + a|
...
* Substitude `GENDER` with the gender of the client.
...
* Substitude `BIRTHDAY` with the birthday of the client.
...
* Substitude `HEIGHT` with the height of the client.
...
* Substitude `TAG` with a tag for the client.
