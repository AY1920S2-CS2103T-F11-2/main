...
Suppose you want to delete an exercise previously saved to a client.

. First, ensure that you are currently viewing the client by using the `view-c` command:
+
...
. First, ensure that you are currently viewing the client (Alex Yeoh in this example) by using the `view-c` command:
+
image::export-1.png[]
