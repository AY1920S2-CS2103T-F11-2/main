...
import static seedu.fitbiz.commons.core.Messages.MESSAGE_INVALID_CLIENT_DISPLAYED_INDEX;
import static seedu.fitbiz.commons.core.Messages.MESSAGE_UNKNOWN_COMMAND;
...
import seedu.fitbiz.logic.commands.ListCommand;
...
public class LogicManagerTest {
     ...
     */
    private static class JsonFitBizIoExceptionThrowingStub extends JsonFitBizStorage {
        private JsonFitBizIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
