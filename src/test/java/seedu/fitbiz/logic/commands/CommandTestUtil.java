...
import static seedu.fitbiz.logic.parser.CliSyntax.PREFIX_DAY;
import static seedu.fitbiz.logic.parser.CliSyntax.PREFIX_EMAIL;
import static seedu.fitbiz.logic.parser.CliSyntax.PREFIX_END_TIME;
...
import static seedu.fitbiz.logic.parser.CliSyntax.PREFIX_START_TIME;
...
public class CommandTestUtil {
    ...
    public static final String VALID_TIME_START = "1200";
    public static final String VALID_TIME_END = "1400";
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        FitBiz expectedFitBiz = new FitBiz(actualModel.getFitBiz());
        List<Client> expectedFilteredList = new ArrayList<>(actualModel.getFilteredClientList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedFitBiz, actualModel.getFitBiz());
